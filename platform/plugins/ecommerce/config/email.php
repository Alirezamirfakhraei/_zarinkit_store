...
return [
    ...
    'templates'   => [
        'welcome'                 => [
            'title'       => 'خوش آمد گویی',
            'description' => 'زمانی که کاربر در سایت ما حساب کاربری ثبت کرد، ایمیلی را برای آنها ارسال کنید',
        ...
        'confirm-email'           => [
            'title'       => 'ایمیل تایید',
            'description' => 'زمانی که کاربر یک حساب کاربری را ثبت کرد، ایمیلی برای تایید ایمیل خود ارسال کنید',
            'subject'     => 'Confirm Email Notification',
            'can_off'     => false,
        ],
        'password-reminder'       => [
            'title'       => 'بازنشانی رمز عبور',
            'description' => 'هنگام درخواست بازنشانی رمز عبور، برای کاربر ایمیل ارسال کنید',
