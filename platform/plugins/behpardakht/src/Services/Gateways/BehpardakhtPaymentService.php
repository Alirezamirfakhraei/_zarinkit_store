...
use Botble\Behpardakht\Services\Abstracts\BehpardakhtPaymentAbstract;
use Exception;
use Illuminate\Support\Arr;

class BehpardakhtPaymentService extends BehpardakhtPaymentAbstract
{
    /**
     * Make a payment
     *
    ...
    public function makePayment(array $data)
    {
        ...
        $queryParams = [
            'type'          => BEHPARDAKHT_PAYMENT_METHOD_NAME,
            'amount'        => $amount,
            'currency'      => $currency,
    ...
    public function afterMakePayment(array $data)
    {
        ...
        $chargeId = session('behpardakht_payment_id');
        ...
        session()->forget('behpardakht_payment_id');
